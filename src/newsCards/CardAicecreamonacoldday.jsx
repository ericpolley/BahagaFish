...
<p className='text-center text-md mb-7 font-semibold'>Northern USA bans ice cream</p>
<p className='text-center text-xs mb-4 font-thin'>Published: 12/27/2022</p>
  <img src="https://cdn.pixabay.com/photo/2017/08/03/14/38/ice-cream-2576622_960_720.jpg" className='w-[60vw] lg:w-[30vw] lg:h-[30vh] h-[40vh] object-cover border-4 rounded-xl border-blue-300 mb-2' alt="img" />
