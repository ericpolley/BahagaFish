  ...
  return (
    ...
    <div className='flex justify-center items-center shadow-xl border-2 bg-opacity-50 border-gray-300 bg-blue-100 fixed w-full h-auto m-0 p-0'>
        ...
        <div className=' border-blue-200 border-4 rounded-full bg-sky-300 w-28 flex justify-center items-center'>
            ...
            onClick={()=>navigate('/News')} alt="fish" className='cursor-pointer h-20 w-24 p-1  md:m-1' />
            </div>
        ...
        <div className='flex justify-between w-full sm:w-[90%] md:w-[70%] lg:w-[50%] ml-6 lg:ml-12'> 
            <p onClick={()=>navigate('/')} className={`text-slate-400 hover:text-blue-500 active:text-blue-400 m-3 cursor-pointer ${pathMatchRoute("/") && "text-blue-800 border-b-2 border-blue-400"}`}>Home</p>
            <p onClick={()=>navigate('/News')} className={`text-slate-400 hover:text-blue-500 active:text-blue-400 m-3 cursor-pointer ${pathMatchRoute("/News") && "text-blue-800 border-b-2 border-blue-400"}`}>News</p>
            <p onClick={()=>navigate('/About')} className={`text-slate-400 hover:text-blue-500 active:text-blue-400 m-3 cursor-pointer ${pathMatchRoute("/About") && "text-blue-800 border-b-2 border-blue-400"}`}>About</p>
