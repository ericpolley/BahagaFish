      ...
      <div className='flex flex-col items-center justify-center'>
        <div className='flex flex-col items-center'>
          <form  className='w-[360px] rounded-lg border-4 border-blue-200 flex flex-col items-center text-center bg-blue-100'>
            ...
            <p className='w-[50%] mb-12 mt-8 m-3 cursor-pointer bg-blue-400 p-3 text-white font-medium rounded-xl hover:bg-blue-500 active:bg-blue-600'>Sign In</p>
          </form>
          <p className='mt-8 text-gray-400 text-center'>Already have an account?</p>
        <p onClick={()=>navigate('/SignUp')} className='m-3 text-center cursor-pointer bg-green-400 p-3 text-white font-medium rounded-xl hover:bg-green-500 active:bg-green-600'>Sign Up Instead</p>
        </div>
        </div>
    </div>
    </div>
